    ...
    <div className="z-40 -mt-16" id="contact">
      <section className="bg-[#082231]">
        <div className="py-20 2xl:max-w-7xl max-w-6xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-popins text-white text-center mb-5">
            Contact Me
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-x-5 md:gap-y-0 mt-10">
            <div className="space-y-5" data-aos="zoom-in-up">
              <h2 className="text-transparent bg-gradient-to-r from-[#2782e9] to-sky-200 bg-clip-text text-4xl lg:text-5xl font-bold">
                {"Let's Talk"}
              </h2>
            ...
            >
              <div>
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  className="shadow-sm border-2 outline-none focus:border-gray-400 text-sm rounded-lg block w-full p-2.5 bg-white/20 border-gray-600 placeholder-gray-400 text-white"
                  placeholder={contactInfo.FormPlaceholders.Email}
                  required
                />
              </div>
              <div>
                ...
                <input
                  ...
                  name="subject"
                  className="shadow-sm border-2 outline-none focus:border-gray-400 text-sm rounded-lg block w-full p-2.5 bg-white/20 border-gray-600 placeholder-gray-400 text-white"
                  placeholder={contactInfo.FormPlaceholders.Subject}
                  required
                />
              </div>
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  placeholder={contactInfo.FormPlaceholders.Message}
                  required
                ></textarea>
              </div>
              ...
              <button
                type="submit"
                className="btn btn-info w-full bg-gradient-to-r from-[#00A6E8] to-[#0081b5] text-white text-lg border-0 outline-0"
              >
                Send
