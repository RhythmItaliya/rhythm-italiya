          ...
          <div className="flex justify-between items-center ">
            ...
            >
              <div className="flex items-center">
                <Image
                  priority={false}
                  className="h-8 w-auto sm:h-10 md:h-12 lg:h-14 px-4"
                  src={Logo}
                  alt="logo"
                />
              </div>
            ...
            <div className="hidden md:block">
              <ul className="flex flex-row gap-x-7 items-center">
                {aboutMe.links.map((link, index) => (
                  <li
                    key={index}
                    className="text-base lg:text-lg font-popins font-medium text-white"
                  >
                    <Link
            ...
            <div className="flex items-center gap-x-3">
              ...
              <HiOutlineMenu
                ...
                className="text-3xl text-gray-200 mr-3 md:hidden"
              />
            </div>
          </div>
        </div>
          ...
          title={
            ...
            >
              <div className="flex items-center">
                <Image
                  priority={false}
                  className="h-10 w-auto md:h-12 lg:h-14 ml-3"
                  src={Logo}
                  alt="logo"
                />
              </div>
        ...
        >
          <ul className="flex flex-col gap-y-5 pl-5">
            {aboutMe.links.map((link, index) => (
              <li
                key={index}
                className="text-lg font-popins font-medium text-white"
              >
                <Link
