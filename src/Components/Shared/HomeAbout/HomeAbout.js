...
const HomeAbout = () => {
  return (
    <div className="2xl:max-w-7xl max-w-6xl mx-auto px-4 pb-24 md:pb-0">
      <div className="min-h-[calc(100vh-64px)] flex items-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-0 gap-y-5 md:gap-5 mt-6 md:mt-0 text-white items-center min-h-[calc(100vh-64px)]">
          <div
            ...
            className="order-2 md:order-1 text-center md:text-left md:mb-0"
          >
            <h1 className="mt-6 md:mt-0 text-4xl md:text-5xl lg:text-6xl font-bold font-popins mb-4 md:mb-5">{`Hi, I'm`}</h1>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold font-popins mb-4 md:mb-5">
              {aboutMe.Name}
            </h2>
            ...
            <h5 className="hidden md:block mt-5 mb-7 md:mb-8 lg:mb-10 text-lg lg:text-xl font-popins text-gray-400">
              {aboutMe.Introduction}
            </h5>

            <div className="flex justify-center md:justify-start items-center gap-4 md:gap-0 mt-6 md:mt-0">
              <a
                href={aboutMe.Resume.drive}
                target="blank"
                className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-[#00A4E6] rounded-xl group"
              >
                ...
                <span className="absolute bottom-0 left-0 w-full h-full transition-all duration-500 ease-in-out delay-200 -translate-x-full translate-y-full bg-[#0082B6] rounded-2xl group-hover:mb-12 group-hover:translate-x-0"></span>
              ...
              <a
                ...
                target="blank"
                className="relative mx-5 px-5 py-2 font-medium text-white group"
              >
          ...
          <div data-aos="zoom-in-left" className="mx-auto order-1 md:order-2">
            <div className="mockup-code w-80 md:w-40 lg:w-full bg-white/5 text-gray-300">
              ...
              <pre data-prefix="2">
                <code>{`  Name: "${aboutMe.Name}",`}</code>
              </pre>
              <pre data-prefix="3">
                <code>{`  Role: "${aboutMe.Role}",`}</code>
              </pre>
              <pre data-prefix="4">
                <code>{`  Age: ${aboutMe.Age},`}</code>
              </pre>
              <pre data-prefix="5">
                <code>{`  Gender: "${aboutMe.Gender}",`}</code>
              </pre>
              <pre data-prefix="6">
                <code>{`  Address: "${aboutMe.Address}"`}</code>
              </pre>
              <pre data-prefix="7">
                <code>{`  Phone: "${aboutMe.Phone}"`}</code>
              </pre>
              <pre data-prefix="8">
                <code>{`  Email: "${aboutMe.Email}",`}</code>
              </pre>
              <pre data-prefix="9">
                <code>{`  Language: [`}</code>
              </pre>
