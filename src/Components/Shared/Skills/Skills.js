...
const skillsData = [
    ...
    },
    {
        title: "Backend",
        icons: [
            { component: <SiMysql className="text-[20px] md:text-[40px] text-white" />, tooltip: "MySQL" },
            { component: <SiMongodb className="text-green-500 text-[16px] md:text-[32px]" />, tooltip: "MongoDB" },
            { component: <SiFirebase className="text-[16px] md:text-[32px] text-yellow-400" />, tooltip: "Firebase" },
            { component: <FaNodeJs className="text-green-400 text-[16px] md:text-[32px]" />, tooltip: "Node.js" },
            { component: <SiExpress className="text-white text-[16px] md:text-[32px]" />, tooltip: "Express.js" },
            { component: <SiSequelize className="text-green-400 text-[16px] md:text-[32px]" />, tooltip: "Sequelize" },
        ],
    },
    {
        title: "Tools & Others",
        icons: [
            { component: <FaGithub className="text-white text-[16px] md:text-[32px]" />, tooltip: "GitHub" },
            { component: <SiGit className="text-red-500 text-[16px] md:text-[32px]" />, tooltip: "Git" },
            { component: <FaAws className="text-yellow-300 text-[16px] md:text-[32px]" />, tooltip: "AWS" },
            { component: <Image fill={true} src='https://i.ibb.co/WBs41jh/vercel-copy.png' alt="Vercel logo" />, tooltip: "Vercel" },
            { component: <BiLogoNetlify className="text-[#3DB7B6] text-[16px] md:text-[32px]" />, tooltip: "Netlify" },
            { component: <DiDocker className="text-[#29A3F1] text-[16px] md:text-[32px]" />, tooltip: "Docker" },
            { component: <SiVisualstudiocode className="text-[#29A3F1] text-[16px] md:text-[32px]" />, tooltip: "Visual Studio Code" },
            { component: <FaLinux className="text-gray-400 text-[16px] md:text-[32px]" />, tooltip: "Linux" },
        ],
    },
];
