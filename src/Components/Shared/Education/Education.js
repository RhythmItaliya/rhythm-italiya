...
const Education = () => {
  return (
    <div
      className="bg-gradient-to-bl from-[#082231] to-[#051620] -mt-16 z-30 pb-28"
      id="education"
    >
      <div className="2xl:max-w-7xl max-w-6xl mx-auto px-4">
        ...
        <div className="space-y-10">
          <div className="text-center">
            <h3 className="text-2xl font-bold font-popins text-white">
              Degrees
            </h3>
            <p className="text-sm text-gray-400">Formal degree programs</p>
          </div>

          <div className="mx-auto space-y-8">
            {educationData.degrees &&
              educationData.degrees.map((institution, index) => (
                <div
                  key={index}
                  data-aos="fade-up"
                  className="bg-white/5 border border-[#174d63] w-[350px] md:w-[440px] lg:w-[480px] mx-auto p-5 rounded-lg shadow-xl shadow-[#0d161a]"
                >
                  <div className="flex flex-row gap-x-2 md:gap-x-3 lg:gap-x-4 justify-between items-center">
                    <div>
                      <h3 className="text-base md:text-lg lg:text-xl font-popins font-bold text-gray-300">
                        {institution.name}
                      </h3>
                      <p className="text-sm md:text-base lg:text-lg font-bold font-popins text-gray-400">
                        {institution.course}
                      </p>
                      <p className="text-xs font-bold font-popins text-gray-400">
                  ...
                  {institution.grade && (
                    <h4 className="text-sm font-popins font-bold text-gray-400 mt-2">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-400">
              Short programs and certifications
            </p>
          </div>

          <div className="mx-auto space-y-8">
            {educationData.certifiedCourses &&
              educationData.certifiedCourses.map((course, index) => (
                <div
                  key={index}
                  data-aos="fade-up"
                  className="bg-white/5 border border-[#174d63] w-[350px] md:w-[440px] lg:w-[480px] mx-auto p-5 rounded-lg shadow-xl shadow-[#0d161a]"
