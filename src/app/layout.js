...
export const metadata = {
  ...
  description:
    "Rhythm Italiya - Full Stack Developer specializing in modern web technologies and creating dynamic, user-friendly applications.",
  url: "https://rhythmitaliya.com",
  image:
    "https://res.cloudinary.com/ds9ufpxom/image/upload/v1727323304/Img/nruph7xbowtmlxslzacv.png",
  ...
  keywords:
    "Rhythm Italiya, Full Stack Developer, Web Development, MERN Stack Developer,Node.js Developer, React.js Developer",
  robots: "index, follow",
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="google-site-verification" content="E0B-qUKLp2H_c2lS6WG7oKTK3YWxiTOMFdbKpDpLKtc" />
